  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <span className="text-[#98989F] font-medium text-[10px] uppercase tracking-[0.5em]">
            02 // Journey & Trust
          </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 md:gap-24">
          ...
          <div className="lg:col-start-9 lg:col-span-4 space-y-16">
            ...
            >
              Social <span className="italic text-[#98989F]">Proof.</span>
            </motion.h3>
            ...
            >
              <div
                className="group flex items-center justify-between py-5 border-t border-zinc-900"
                onClick={() =>
                  toast.success("LinkedIn Recommendations coming soon!")
                }
              >
                <span className="text-[9px] font-medium uppercase tracking-[0.2em] text-[#98989F] group-hover:text-white transition-colors">
                  LinkedIn Recommendations
                </span>
                <ArrowUpRight
                  size={14}
                  className="text-[#9999A3] group-hover:text-white transition-all group-hover:translate-x-1 group-hover:-translate-y-1"
                />
              </div>
            </motion.div>
          </div>
