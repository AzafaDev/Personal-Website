            ...
            <div className="space-y-12 text-right lg:text-left">
              {contactInfo.map((info, idx) => (
                <div key={idx} className="space-y-1">
                  ...
                  <a
                    href={info.link}
                    className="text-xl font-bold hover:text-blue-400 transition-colors tracking-tight"
                  >
                    {info.value}
                  </a>
                </div>
                ...
                <div className="flex justify-end lg:justify-start gap-6 pt-4">
                  {socials.map((social, idx) => (
                    <a
                      ...
                      href={social.link}
                      target="_blank"
                      className="text-sm font-black uppercase tracking-widest hover:text-blue-400 transition-colors border-b border-transparent hover:border-blue-600"
                    >
                      {social.name}
                    </a>
                  ))}
