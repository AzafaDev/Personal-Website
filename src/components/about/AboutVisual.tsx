    ...
    <div className="absolute -bottom-6 -right-6 bg-zinc-900 border border-white/10 p-4 shadow-2xl">
      <div className="flex items-center gap-3">
        ...
        <div className="flex flex-col">
          <span className="text-[10px] font-black uppercase text-zinc-500">Purwadhika</span>
          <span className="text-[10px] font-black uppercase text-white tracking-widest leading-none mt-1">Alumni</span>
        </div>
      </div>
    </div>
  </div>
