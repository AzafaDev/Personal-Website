  ...
  <div className="group relative border-b border-zinc-900 py-10 md:py-12 transition-all duration-500 hover:bg-zinc-950/50 active:bg-zinc-900 md:active:bg-transparent">
    <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-8 lg:gap-0">
      ...
      <div className="lg:col-span-1 hidden lg:flex items-center">
        <span className="font-mono text-white text-lg group-hover:text-blue-400 transition-colors">
          {group.id}
        </span>
      </div>
      ...
      <div className="lg:col-span-5">
        ...
        <p className="text-white text-xs md:text-sm max-w-sm">
          {group.description}
        </p>
      </div>
          ...
          {group.skills.map((skill, idx) => {
            ...
            return (
              <div key={idx} className="flex flex-col items-center gap-2">
                ...
                <span className="text-[9px] md:text-[10px] font-mono text-white md:text-white md:group-hover:text-white transition-colors uppercase tracking-widest">
                  {skill.name}
                </span>
              </div>
            );
      ...
      <div className="hidden lg:col-span-1 lg:flex justify-end pr-4">
        <ArrowRight
          className="text-white md:text-white group-hover:text-blue-400 group-hover:translate-x-2 transition-all duration-500"
          size={24}
        />
      </div>
    </div>
