    ...
    <div className="relative aspect-square sm:aspect-[4/5] w-full">
      ...
      <div className="absolute inset-0 bg-zinc-900 overflow-hidden border border-zinc-800 z-10">
        <img
          ...
          onError={(e) => {
            ...
            e.currentTarget.src =
              "https://via.placeholder.com/400x500/111111/444444?text=Profile+Photo";
          }}
        />
      </div>
      ...
      <div className="absolute -bottom-6 -left-6 sm:-bottom-10 sm:-left-10 bg-white p-4 sm:p-6 hidden sm:block border border-zinc-200 z-20 shadow-xl">
        <div className="flex flex-col">
          <span className="text-4xl sm:text-6xl font-black text-black leading-none tracking-tighter italic">
            3+
          </span>
          <span className="text-[8px] sm:text-[10px] font-black text-white uppercase tracking-widest mt-1 sm:mt-2">
