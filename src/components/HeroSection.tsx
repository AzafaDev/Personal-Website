    ...
    <section className="relative w-full min-h-[90vh] flex items-center justify-center overflow-hidden text-white px-6 py-20">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center z-10">
        ...
        >
          ...
          <motion.p
            variants={itemVariants}
            className="text-gray-400 text-lg md:text-xl max-w-xl mx-auto lg:mx-0 leading-relaxed font-light"
          >
            Building scalable and{" "}
            <span className="text-white font-medium">
              high-performance web solutions
            </span>{" "}
            for your business needs. I craft immersive web experiences where art
            meets logic.
          </motion.p>
